          ...
          <div className="col-md-6">
            <div className="div">
              ...
              <div className="d-flex justify-content-between px-2">
                <a href="https://www.facebook.com/B.Yanns">
                  <FaFacebook className="footer-icons" />
                </a>

                <a href="https://www.instagram.com/yannisyoussef/">
                  <FaInstagram className="footer-icons" />
                </a>
                                
                <a href="https://fr.linkedin.com/in/yannis-ba-bineni-607b5a130">
                  <FaLinkedinIn className="footer-icons" />
                </a>

                <a href="https://github.com/yannisyoussef">
