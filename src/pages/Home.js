...
function Home() {
  return (
    <div>
      ...
      >
        <div>
          <h1 data-aos='fade-up'>YANNIS</h1>

          <div className="intro-content d-flex justify-content-between">
            <p>
              Full Stack <br /> Developer , Tester
            </p>
